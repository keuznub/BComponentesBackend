...
var AuthController = /*#__PURE__*/ function() {
    ...
    _create_class(AuthController, null, [
        {
            key: "register",
            value: function register(req, res, next) {
                return _async_to_generator(function() {
                    var userData, newUser, error;
        ...
        },
        {
            ...
            value: function login(req, res, next) {
                return _async_to_generator(function() {
                    var userData, token, _jwt_decode, id, role, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                            ...
                            case 1:
                                ...
                                _jwt_decode = jwt.decode(token), id = _jwt_decode.id, role = _jwt_decode.role;
                                res.status(201).json({
