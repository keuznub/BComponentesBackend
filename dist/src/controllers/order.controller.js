...
export var OrderController = /*#__PURE__*/ function() {
    "use strict";
    function OrderController() {
        _class_call_check(this, OrderController);
    }
    _create_class(OrderController, null, [
        {
            key: "getAll",
        ...
        },
        {
            ...
            value: function save(req, res, next) {
                return _async_to_generator(function() {
                    var orderProduct, idUser, result, error;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                                ...
                                return [
                                    4,
                                    OrderService.save(orderProduct, idUser)
                                ];
                            case 1:
                                result = _state.sent();
