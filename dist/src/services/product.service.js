...
export var ProductService = /*#__PURE__*/ function() {
    ...
    _create_class(ProductService, null, [
        ...
        {
            key: "save",
            value: function save(product, categoriesId) {
                return _async_to_generator(function() {
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    ...
                                    prisma.product.create({
                                        data: _object_spread_props(_object_spread({}, product), {
                                            categoryProduct: {
                                                connect: {
                                                    idCategory: categoriesId[0]
                                                }
                                            }
                                        })
                                    })
